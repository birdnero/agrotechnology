...
public class WareHouseWithFridge extends WareHouse {
     ...
     */
    public WareHouseWithFridge(String type, String location, int size, int capacity, double freshness, ArrayList<StorageCell> storage, double fridgeWithAccumulator) {
