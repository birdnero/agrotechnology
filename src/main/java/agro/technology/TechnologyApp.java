 ...
 * 
 * !Будівельник (Builder) мати кончтруктор і готові конфігурації
 ...
 * 
 * * Компоновщик (Composite) - дерево (делегування спуск дії до низу залежності)
